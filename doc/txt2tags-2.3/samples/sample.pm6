...
<@Normal:>
We use double *, / and _ to represent <B>bold<P>, <I>italic<P> and <U>underline<P>.
...
<@Normal:>
Or use <FONT "Lucida Console"><SIZE 9>preformatted<SIZE$><FONT$> inside sentences.
...
<@Normal:>
So today is 20050614 on the ISO <FONT "Lucida Console"><SIZE 9>YYYYMMDD<SIZE$><FONT$> format.

<@Normal:>
You can also specify the date format with the %? flags, as <FONT "Lucida Console"><SIZE 9>%%date(%m-%d-%Y)<SIZE$><FONT$> which gives: 06-14-2005.
